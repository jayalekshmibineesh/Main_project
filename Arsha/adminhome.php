...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="login.php">change password</a></li> 
  ...
  <!-- <div class="card" style="width: 40rem; height:30rem;background-color:skyblue">
  <div class="card-body">
    <h3 class="card-title">Admin</h3><br><br>
     <h6 class="card-subtitle mb-2 text-body-secondary">Card subtitle</h6> -->
    <!-- <p class="card-text">admin can view thecustomers and users details from here  </p>
    <br> <br><a href="view_customers.php" class="card-link">Customers</a>
    <a href="view_owners.php" class="card-link">Owners</a>
    <a href="viewturf" class="card-link">Turf</a>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Our website will be easily avialabe even if there is heavy traffic </p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>We provide first-aid facility including nursing stations</p>
            </div>
          </div>
